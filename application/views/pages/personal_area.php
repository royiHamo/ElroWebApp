		...
		<div class="container">
			...
			<div class="breadcrumb-header justify-content-between">
				<div class="left-content">
					<div>
						<h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">Hi, welcome back <?php echo ucfirst(strtok($email,'@'));?>!</h2>
						<p class="mg-b-0">Attacks monitoring dashboard</p>
					</div>
				</div>
...
<script>
		//TODO: confirm before updating db(services) on checkbox change
